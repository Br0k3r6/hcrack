...
# 21 "sha256.c"
 ...
 printf("[HCRACK][i] Hash loaded from file(SHA256) : %s\n", argv[1]);
...
# 28 "sha256.c"
 ...
 printf("[HCRACK][i] SHA256(hash) crack started at : %s\n", asctime(tm));
...
# 46 "sha256.c"
   ...
   printf("[HCRACK][+] Password(SHA256)  : %s\n", ibuf);
...
# 55 "sha256.c"
 ...
 printf("[HCRACK][+] Password(SHA256)  : KEY NOT FOUND!\n");
