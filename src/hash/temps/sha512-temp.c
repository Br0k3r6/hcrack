...
# 26 "sha512.c"
 ...
 printf("[HCRACK][i] Hash loaded from file(SHA512) : %s\n", argv[1]);
...
# 35 "sha512.c"
 ...
 printf("[HCRACK][i] SHA512(hash) crack started at : %s\n", asctime(tm));
...
# 47 "sha512.c" 3 4
                    64
# 47 "sha512.c"
                                        ; i++) sprintf(outputBuffer + (i * 2), "%02x", obuf[i]);
...
# 49 "sha512.c"
   ...
   printf("[HCRACK][+] Password(SHA512)  : %s\n", ibuf);
...
# 58 "sha512.c"
 ...
 printf("[HCRACK][+] Password(SHA512)  : KEY NOT FOUND!\n");
