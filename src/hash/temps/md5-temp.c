...
# 12 "/usr/include/openssl/md5.h" 3 4
...
# 15 "/usr/include/openssl/md5.h" 2 3 4
...
# 23 "/usr/include/openssl/md5.h" 2 3 4
# 1 "/usr/lib/gcc/x86_64-linux-gnu/12/include/stddef.h" 1 3 4
...
# 24 "/usr/include/openssl/md5.h" 2 3 4
# 41 "/usr/include/openssl/md5.h" 3 4
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int MD5_Init(MD5_CTX *c);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int MD5_Update(MD5_CTX *c, const void *data, size_t len);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int MD5_Final(unsigned char *md, MD5_CTX *c);
__attribute__((deprecated("Since OpenSSL " "3.0"))) unsigned char *MD5(const unsigned char *d, size_t n,
                                         unsigned char *md);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void MD5_Transform(MD5_CTX *c, const unsigned char *b);
# 6 "md5.c" 2
...
# 23 "md5.c"
 ...
 printf("[HCRACK][i] Hash loaded from file(MD5) : %s\n", argv[1]);
...
# 30 "md5.c"
 ...
 printf("[HCRACK][i] MD5(hash) crack started at : %s\n", asctime(tm));

 printf("[HCRACK][+] Cracking hash that loaded from file...\n");
...
# 41 "md5.c" 3 4
                16
# 41 "md5.c"
                                 ; i++) sprintf(&string[i*2], "%02x", (unsigned int)digest[i]);
...
# 44 "md5.c"
   ...
   printf("[HCRACK][+] Password(MD5)     : %s\n", word);
   printf("[HCRACK][i] Crack finished at : %s\n", asctime(tms));
   fclose(fp);
   exit(
# 49 "md5.c" 3 4
       0
...
# 53 "md5.c"
 ...
 struct tm *tmf = localtime(&tf);

 printf("[HCRACK][+] Password(MD5)     : KEY NOT FOUND!\n");
 printf("[HCRACK][i] Crack finished at : %s", asctime(tmf));
 return 0;
}
