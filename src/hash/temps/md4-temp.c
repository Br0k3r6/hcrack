...
# 12 "/usr/include/openssl/md4.h" 3 4
...
# 15 "/usr/include/openssl/md4.h" 2 3 4
...
# 23 "/usr/include/openssl/md4.h" 2 3 4
# 1 "/usr/lib/gcc/x86_64-linux-gnu/12/include/stddef.h" 1 3 4
...
# 24 "/usr/include/openssl/md4.h" 2 3 4
# 42 "/usr/include/openssl/md4.h" 3 4
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int MD4_Init(MD4_CTX *c);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int MD4_Update(MD4_CTX *c, const void *data, size_t len);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int MD4_Final(unsigned char *md, MD4_CTX *c);
__attribute__((deprecated("Since OpenSSL " "3.0"))) unsigned char *MD4(const unsigned char *d, size_t n,
                                         unsigned char *md);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void MD4_Transform(MD4_CTX *c, const unsigned char *b);
# 4 "md4.c" 2
...
# 23 "md4.c"
 ...
 printf("[HCRACK][i] Hash loaded from file(MD4) : %s\n", argv[1]);
...
# 30 "md4.c"
 ...
 printf("[HCRACK][i] MD4(hash) crack started at : %s\n", asctime(tm));
...
# 53 "md4.c"
 ...
 printf("[HCRACK][+] Password(MD4)     : KEY NOT FOUND!\n");
